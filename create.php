...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO sinh_vien (ma_sv, ho_ten, gioi_tinh, ngay_sinh, hinh, ma_nganh) VALUES (?, ?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssssss", $ma_sv, $ho_ten, $gioi_tinh, $ngay_sinh, $hinh, $ma_nganh);
    $stmt->execute();
    $conn->close();
    ...
    <div class="container">
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="ho_ten" id="ho_ten" class="input-field" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="date" name="ngay_sinh" id="ngay_sinh" class="input-field" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="ma_nganh" id="ma_nganh" class="input-field" required>
            </div>
